module github.com/sayerxofficial/langchaingo
...
//   - import "github.com/sayerxofficial/langchaingo/llms/openai" → only OpenAI-related deps
//   - import "github.com/sayerxofficial/langchaingo/vectorstores/chroma" → only Chroma deps
