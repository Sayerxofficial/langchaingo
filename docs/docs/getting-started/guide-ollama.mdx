...
2. **Run the example**: Enter the command:
   ```shell
   go run github.com/sayerxofficial/langchaingo/examples/ollama-completion-example@main-sayerxofficial
   ```
...
Here is the entire program (from [ollama-completion-example](https://github.com/sayerxofficial/langchaingo/blob/main/examples/ollama-completion-example/ollama_completion_example.go)):
