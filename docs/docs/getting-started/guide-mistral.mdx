...
```shell
go run github.com/sayerxofficial/langchaingo/examples/mistral-completion-example@main-sayerxofficial
```
...
Here is the entire program (from [mistral-completion-example](https://github.com/sayerxofficial/langchaingo/blob/main/examples/mistral-completion-example/mistral_completion_example.go)):
