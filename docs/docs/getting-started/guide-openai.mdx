...
```shell
go run github.com/sayerxofficial/langchaingo/examples/openai-completion-example@main-sayerxofficial
```
...
Here is the entire program (from [openai-completion-example](https://github.com/sayerxofficial/langchaingo/blob/main/examples/openai-completion-example/openai_completion_example.go)):
