...
```go
import "github.com/sayerxofficial/langchaingo/llms/openai"
...
```go
import "github.com/sayerxofficial/langchaingo/llms/anthropic"
...
```go
import "github.com/sayerxofficial/langchaingo/llms/googleai"
...
```go
import "github.com/sayerxofficial/langchaingo/llms/vertexai"
...
```go
import "github.com/sayerxofficial/langchaingo/llms/ollama"
...
```go
import "github.com/sayerxofficial/langchaingo/llms/huggingface"
