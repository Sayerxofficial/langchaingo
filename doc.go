...
//
//   - [github.com/sayerxofficial/langchaingo/llms]: Interfaces and implementations for various language models (OpenAI, Anthropic, Google, etc.)
//   - [github.com/sayerxofficial/langchaingo/chains]: Composable operations that can be linked together to create complex workflows
//   - [github.com/sayerxofficial/langchaingo/agents]: Autonomous entities that can use tools to accomplish tasks
//   - [github.com/sayerxofficial/langchaingo/embeddings]: Text embedding functionality for semantic search and similarity
//   - [github.com/sayerxofficial/langchaingo/vectorstores]: Interfaces to vector databases for storing and querying embeddings
//   - [github.com/sayerxofficial/langchaingo/memory]: Conversation history and context management
//   - [github.com/sayerxofficial/langchaingo/tools]: External tool integrations (web search, calculators, databases, etc.)
//
// # Quick Start
//
...
//		"github.com/sayerxofficial/langchaingo/vectorstores/chroma"
//	)
//
//	// Create an embedder
...
//		"github.com/sayerxofficial/langchaingo/tools/calculator"
//	)
//
//	// Create tools
...
//
//	import "github.com/sayerxofficial/langchaingo/llms"
//
//	if err != nil {
...
//
//	import "github.com/sayerxofficial/langchaingo/internal/httprr"
//
