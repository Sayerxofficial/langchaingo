...
This is a fork of the original [github.com/tmc/langchaingo](https://github.com/tmc/langchaingo) repository. This fork was created to incorporate functionality from open Pull Requests that haven't been merged into the original repository yet and to add custom improvements for use in the [XNeusAGI](https://github.com/sayerxofficial/pentagi) project.
...
> If you want to ask a question, we assume that you have read the available [Documentation](https://pkg.go.dev/github.com/sayerxofficial/langchaingo).

Before you ask a question, it is best to search for existing [Issues](https://github.com/sayerxofficial/langchaingo/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/sayerxofficial/langchaingo/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read the [documentation](https://pkg.go.dev/github.com/sayerxofficial/langchaingo). If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/sayerxofficial/langchaingo/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/sayerxofficial/langchaingo/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- Make sure that you are using the latest version.
- Read the [documentation](https://pkg.go.dev/github.com/sayerxofficial/langchaingo) carefully and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/sayerxofficial/langchaingo/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project. It's up to you to make a strong case to convince the project's developers of the merits of this feature. Keep in mind that we want features that will be useful to the majority of our users and not just a small subset. If you're just targeting a minority of users, consider writing an add-on/plugin library.

#### How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [GitHub issues](https://github.com/sayerxofficial/langchaingo/issues).
...
3. Create a working branch from the `main-sayerxofficial` branch and start with your changes!

**Important**: Note that the `main-sayerxofficial` branch undergoes rebasing as we sync with upstream, so its commit hashes will change over time. Always create Pull Requests based on the current state of the `main-sayerxofficial` branch.
...
=======
- Base your PR against the `main-sayerxofficial` branch, not the `main` branch.
